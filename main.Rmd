...
Interactive graphics give users the chance to manipulate the graphes for additional information. This is especially useful for spatio-temporal data since it would be interesting to explore the correlation between nearby sites on the map or compare between clusters. Underlying each interactive graphic system is a pipeline workflow that communicates the user action down the workflow to [...]. Various such workflow has been proposed in the 90s literature, including [...]. Current general purpose R implementation on iterative graphics includes: plotly [@plotly] for [...]; ggiraph [@ggiraph] for [...]; crosstalk[@crosstalk] for [...]. Specifically for spatio-temporal data, there is tmap [@map], leftlet [@leaflet], mapview [@mapview]. 

some common interactive actions include zoom and panning, tooltip/ highlight, and more advanced cross-linking. 
