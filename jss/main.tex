...
\begin{CodeChunk}
\begin{CodeInput}
R> cb_long2 <- cb_long %>% make_temporal_tsibble() 
R> all.equal(cb_long2, res_long)
\end{CodeInput}
\begin{CodeOutput}
[1] TRUE
\end{CodeOutput}
...
\begin{CodeChunk}
\begin{CodeInput}
R> #res_nested %>% sf::st_transform(crs = "EPSG:3857")
\end{CodeInput}
\end{CodeChunk}
...
\begin{CodeChunk}
\begin{CodeInput}
R> cb_nested2 <- cb_nested %>% make_spatial_sf() 
R> all.equal(cb_nested2, res_nested)
\end{CodeInput}
\begin{CodeOutput}
[1] TRUE
\end{CodeOutput}
