...
\hypertarget{create}{%
\subsection{Casting into the cubble class}\label{create}}
...
# bbox:     [115.9764, -32.9342, 133.5407, -12.4239]
# temporal: date [date], prcp [dbl], tmax [dbl], tmin [dbl]
  id            lat  long  elev name           wmo_id ts       rain_~1
...
# ... with abbreviated variable name 1: rain_day
\end{CodeOutput}
\end{CodeChunk}
...
# bbox:     [115.9764, -32.9342, 133.5407, -12.4239]
# temporal: date [date], prcp [dbl], tmax [dbl], tmin [dbl]
  id            lat  long  elev name   wmo_id ts       tmax_~1 tmax_~2
  <chr>       <dbl> <dbl> <dbl> <chr>   <dbl> <list>     <dbl>   <dbl>
1 ASN00009021 -31.9  116.  15.4 perth~  94610 <tbl_ts>    25.7   38.6 
2 ASN00010311 -31.9  117. 179   york    94623 <tbl_ts>    26.2   51.1 
3 ASN00010614 -32.9  117. 338   narro~  94627 <tbl_ts>    23.7   45.4 
4 ASN00014015 -12.4  131.  30.4 darwi~  94120 <tbl_ts>    33.1    3.02
5 ASN00015131 -17.6  134. 220   ellio~  94236 <tbl_ts>    34.6   24.7 
# ... with abbreviated variable names 1: tmax_mean, 2: tmax_var
\end{CodeOutput}
\end{CodeChunk}
...
Consider the climate data used in the \pkg{cubble} package, \code{climate_aus}. It contains daily precipitation, minimum and maximum temperature for 639 weather stations across Australia in 2020. The converted sftime object is 13.6830016 times the size of the cubble object:
...
# bbox:     [144.5203, -37.727706, 146.059205, -36.5523]
