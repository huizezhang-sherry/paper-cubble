...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7619}}@{}}
...
1 ASN00086282  145. -37.7 melbourne airport  94866     26.6 <tibble [10 x 4]>
2 ASN00086038  145. -37.7 essendon airport   95866     26.5 <tibble [10 x 4]>
\end{CodeOutput}
\end{CodeChunk}
