...
Different matching functions can be tuned with \texttt{temporal\_match\_fn}, which takes a list of matched time series and additional arguments. By Default, the matching function calculates the number of peaks one series falls into another within a temporal window: \texttt{match\_peak}
