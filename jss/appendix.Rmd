...
The data `climate_full` used in Section 5.3, 5.4, and 5.6 can be obtained in a similar fashion with a change of variable and date parameter in `rnoaa::meteo_pull_monitors()`. The full script is provided below and a copy of the data is also available in the data folder of the paper repository linked above. 
