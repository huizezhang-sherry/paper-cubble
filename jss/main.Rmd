...
options(prompt = "R> ", continue = "+ ",
        ...
        width = 90, styler.cache_root = "styler-perm")
```
...
```{r child = here::here("2-cubble.Rmd")}
...
```{r child = here::here("4-1-covid.Rmd")}

```

```{r child = here::here("4-2-glyph.Rmd")}

```


```{r child = here::here("4-3-matching.Rmd")}
