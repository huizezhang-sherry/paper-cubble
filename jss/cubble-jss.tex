...
The variable \code{tmax} is used by \code{geom_glyph()} to create the glyph map in Figure \ref{fig:basic-manip}. (An insset of one station inset is shown in the top left corner).
...
{\centering \includegraphics[width=0.7\linewidth]{figures/basic-manip-1} 
