...
{\centering \includegraphics[width=1\linewidth]{figures/basic-manip-1} 
...
This function returns a \code{cubble} object, with additional columns: \code{dist} storing the distance between matched stations, \code{group} summarising spatial matching, and \code{n_match} showing the temporal matching.
...
{\centering \includegraphics[width=1\linewidth]{figures/netcdf-1} 
