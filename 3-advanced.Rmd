...
This functionality can be seen as a matching exercise [@stuart2010matching; @mcintosh2018using] in the spatio-temporal domain to pair up nearby observations. It can also be considered as a form of data fusion [@cocchi2019data], where data from multiple sources are combined together. 
