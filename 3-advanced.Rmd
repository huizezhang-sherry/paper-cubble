...
Data fusion is a process that consider combining multiple multiple data sources and it has been applied widely in the remote sensing community.

Meteorological and hydrological data have been matched in the applied studies in the literature to understand drought, ... [ref]. To be a valid pair of matching, the matched pair from different data sources need to
