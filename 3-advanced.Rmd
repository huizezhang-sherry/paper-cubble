...
Spatio-temporal transformation is a useful technique to extract information from spatio-temporal data. Glyph maps [@Wickham2012-yr] transform the time coordinates into the space coordinates to plot the time series of different locations on the map. Calendar plots [@wang2020calendar] reconstruct time into a calendar-based grid to discover weekday and weekend pattern. Projection, or linear combination, of variables summarises multivariate information into lower dimension to further digest. This section elaborates on the glyph map.
