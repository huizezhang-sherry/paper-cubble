...
identifier, geographic coordinates. In this paper, we propose a tidy
data structure for vector spaio-temporal data. \newline
...
\hypertarget{compatibility-with-existing-software}{%
\subsection{Compatibility with existing
software}\label{compatibility-with-existing-software}}
