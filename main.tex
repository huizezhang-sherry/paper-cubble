...
\caption[demon code]{demon code}\label{fig:code1-workflow}
\end{figure}
\end{CodeChunk}
...
\caption[shtishisa]{shtishisa}\label{fig:unnamed-chunk-12}
\end{figure}
\end{CodeChunk}
...
\caption[shtishisaasdf]{shtishisaasdf}\label{fig:unnamed-chunk-15}
\end{figure}
\end{CodeChunk}
...
{\centering \includegraphics[width=1\linewidth]{figures/unnamed-chunk-18-1} 
...
R> 
R> nc <- ncdf4::nc_open(here::here("data/tas_Amon_ACCESS-CM2_ssp585_r1i1p1f1_gn_20150116-20201216_v20191108.nc"))
R> temp <- as_cubble(nc, vars = "tas")
