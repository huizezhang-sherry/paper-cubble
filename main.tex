...
\Keywords{spatio-temporal data, \proglang{R}, climate data}
\Plainkeywords{spatio-temporal data, R, climate data}
...
\pkg{cubble} is also compatible with \pkg{tsibble} where each element
...
created using \texttt{knitr} and \texttt{rmarkdown} in R. The source
code for reproducing this paper can be found
\href{https://github.com/huizezhang-sherry/paper-cubble}{here}.
