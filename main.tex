...
\Abstract{
Exploring spatio-temporal data can sometimes be discouraging given the
various different formats spatio-temporal data can present themselves in
practice. Moreover, the two observational units naturally exist in
spatio-temporal data can cost analysts many time and efforts on
