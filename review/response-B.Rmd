...
**\textcolor{purple}{Re: We select the code and output relevant to demonstrate the cubble package in the examples while leaving the rest in the github repository, where users can look up for more details: https://github.com/huizezhang-sherry/paper-cubble. [on the visualisation packages: xxx]}**
...
My recommendation would be a combination of the following:
  ...
  * Rework section 4 by making it more concise and provide links to sections in supplementary material or dedicated vignettes. **\textcolor{purple}{Re: xxx}**
...
**\textcolor{purple}{Re: [TODO: add documentation on these! ]}**
...
**\textcolor{purple}{Re: [TODO] use tsibble functions to print temporal range in the long form, something looks like:}**

```r
## nested:

# cubble:   key: id [5], index: date, nested form
# extent:   [115.9764, -32.9342, 133.5407, -12.4239]
# temporal: date [date], prcp [dbl], tmax [dbl], tmin [dbl]
